...
public class TagFind extends FsCommand {
    /**
    ...
    public static void registerCommands(CommandFactory factory) {
        factory.addClass(org.apache.hadoop.fs.shell.TagFind.TagFind.class, "-tagfind");
    }

    public static final String NAME = "tagfind";
