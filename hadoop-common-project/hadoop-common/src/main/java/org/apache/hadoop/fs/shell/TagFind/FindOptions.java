...
/**
 * Options to be used by the {@link TagFind} command and its {@link Expression}s.
 */
public class FindOptions {
  ...
  /**
   * Returns the start time of this {@link TagFind} command.
   *
  ...
  /**
   * Set the start time of this {@link TagFind} command.
   *
